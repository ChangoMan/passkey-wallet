...
export const NETWORKS_EXTRA_DATA: Record<string, ChainAttributes> = {
  [chains.hardhat.id]: {
    color: "#b8af0c",
    icon: "/networks-logos/hardhat.png",
  },
  [chains.mainnet.id]: {
    color: "#ff8b9e",
    icon: "/networks-logos/mainnet.svg",
  },
  [chains.sepolia.id]: {
    color: ["#5f4bb6", "#87ff65"],
    icon: "/networks-logos/mainnet.svg",
  ...
  [chains.polygon.id]: {
    ...
    icon: "/networks-logos/polygon.svg",
  },
  ...
  [chains.optimismSepolia.id]: {
    color: "#f01a37",
    icon: "/networks-logos/optimism.svg",
  },
  [chains.optimism.id]: {
    color: "#f01a37",
    icon: "/networks-logos/optimism.svg",
  ...
  [chains.arbitrumSepolia.id]: {
    color: "#28a0f0",
    icon: "/networks-logos/arbitrum.jpg",
  },
  [chains.arbitrum.id]: {
    color: "#28a0f0",
    icon: "/networks-logos/arbitrum.jpg",
